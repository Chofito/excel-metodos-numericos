...
export type MethodKind = 'root' | 'fixed' | 'interpolation' | 'system' | 'nonlinear'
...
export const methods: MethodMeta[] = [
  ...
  },
  {
    ...
    kind: 'system',
    source: 'Hoja15.cls',
    description: 'Sistemas lineales usando valores nuevos en la misma iteracion.',
  },
  {
...
export const methodById = Object.fromEntries(methods.map((method) => [method.id, method])) as Record<
  MethodId,
  MethodMeta
>
